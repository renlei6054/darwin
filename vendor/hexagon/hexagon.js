...
function HexagonGrid(canvasId, radius, color) {
    this.radius = radius;
    this.color = color;
...
HexagonGrid.prototype.drawHexGrid = function (rows, cols, originX, originY, isDebug) {
    ...
    for (var col = 0; col < cols; col++) {
        for (var row = 0; row < rows; row++) {
            ...
            this.drawHex(currentHexX, currentHexY, this.color, debugText);
        }
...
HexagonGrid.prototype.drawHex = function(x0, y0, fillColor, debugText) {
    this.context.strokeStyle = tinycolor(fillColor).darken(5).toString();
